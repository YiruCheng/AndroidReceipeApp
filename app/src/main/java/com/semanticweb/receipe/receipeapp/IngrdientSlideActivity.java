 ...
 *
 * @see IndredientDetailSlidePageFragment
 */
public class IngrdientSlideActivity extends FragmentActivity {
    /**
    ...
    /**
     * A simple pager adapter that represents 5 {@link IndredientDetailSlidePageFragment} objects, in
     * sequence.
     */
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            return IndredientDetailSlidePageFragment.create(position);
        }
